...
.\start_trading_bot.bat    # Restart bot
```
...
> **Note**: The following directories contain generated files and are excluded from version control (except for documentation purposes).

| Directory | Purpose | How to Generate | Safe to Delete |
|:----------|:--------|:----------------|:--------------:|
| `htmlcov/` | pytest HTML coverage reports | `pytest --cov=src --cov-report=html` | ✅ Yes |
| `logs/` | Runtime log files | Auto-generated during bot operation | ✅ Yes |
| `.pytest_cache/` | pytest cache for faster reruns | Auto-generated by pytest | ✅ Yes |
| `__pycache__/` | Python bytecode cache | Auto-generated by Python | ✅ Yes |
| `.venv/` | Virtual environment | `python -m venv .venv` | ✅ Yes |
